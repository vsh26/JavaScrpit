...
// shift() - removes first element from array and moves all other elements to lower index
console.log(cars.shift());
console.log(cars);

// unshift() - add elements to the beginning of the array and moves other elements to higher index
...
// flatMap() - maps all elements of array, then creates new array by flattening the array
let nums1 = [1,2,3,4,5];
...
// toSpliced() - splice an array without altering original array (creates a new array) 
const newPhones = phones.toSpliced(1, 0, "Lenovo");
console.log(newPhones);


// slice() - slices out a pieceof array into new array
