...
// indexOf() - index of first occurrence of beginning of the string
...
//lastIndexOf() - index of last occurrence of beginning of the string
const lastIndex = bigStr.lastIndexOf("Iron");
console.log(lastIndex);

// search() - searches a string for a string (or a regular expression) and returns the position of the match. It cannot take second argument (where to begin search)
...
// includes()
console.log(bigStr.includes("Hulk"));
console.log(bigStr.includes("Iron Man"));
