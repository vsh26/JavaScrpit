/*
    ...
    - replace(str_to_be_replaced, new_str)
    - replaceAll(str_to_be_replaced, new_str)
...
console.log(text.at(21));       // 'V'
console.log(text.at(27));       // undefined
console.log(text.charAt(21));   // 'V'
console.log(text.charAt(27));   // ''
console.log(text[21]);          // 'V'
...
console.log(lowerCaseStr);              // 'abcdefghijklmnopqrstuvwxyz'


// ---------- toUpperCase() ----------
const upperCaseStr = text.toUpperCase();
console.log(upperCaseStr);              // 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'


// ---------- concat() ----------
console.log(text1 + text2);
console.log(text1.concat(" ", text2, " ", text3, " ", text4, " ", text5));  // 'Hello World! Welcome to JavaScript'
...
// ---------- repeat() ----------
// returns a new string with a number of copies of original string
