...
// Object.preventExtensions(object) - prevents new properties from ever being added to an object. It also prevents the object's prototype from being re-assigned.
...
// Object.seal(object) - Sealing an object prevents extensions and makes existing properties non-configurable. A sealed object has a fixed set of properties: new properties cannot be added, existing properties cannot be removed, their enumerability and configurability cannot be changed, and its prototype cannot be re-assigned. Values of existing properties can still be changed as long as they are writable. seal() returns the same object that was passed in.
